 ...
 * @author raidenov
 */
public class PedirTurnos extends javax.swing.JFrame {
    
    Controladora control = new Controladora();
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(PedirTurnos.class.getName());
